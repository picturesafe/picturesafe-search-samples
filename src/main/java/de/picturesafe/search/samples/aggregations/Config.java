...
public class Config {
    ...
    List<FieldConfiguration> fieldConfigurations() {
        return Arrays.asList(
                ...
                // Define fields as 'aggregatable' to be returned as 'Facet' in SearchResult
                StandardFieldConfiguration.builder("city", ElasticsearchType.TEXT).copyToFulltext(true).aggregatable(true).build(),
                StandardFieldConfiguration.builder("tag", ElasticsearchType.TEXT).copyToFulltext(true).aggregatable(true).build(),
                StandardFieldConfiguration.builder("created", ElasticsearchType.DATE).aggregatable(true).build()
        );
    }
}
