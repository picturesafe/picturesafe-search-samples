...
public class SearchDayExpression {
    ...
    public static void main(String[] args) {
        try (AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(SearchDayExpression.class)) {
            final SearchDayExpression searchDayExpression = ctx.getBean(SearchDayExpression.class);
            searchDayExpression.run();
        }
    }
    ...
    private void run() {
        try {
            ...
            final Expression expression = new DayExpression("created", getDate("12.01.2020"));
