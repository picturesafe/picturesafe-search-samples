...
public class SearchMustNotExpression implements PicturesafeSearchSample {
    ...
    public static void main(String[] args) {
        try (AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(SearchMustNotExpression.class)) {
            final SearchMustNotExpression searchMustNotExpression = ctx.getBean(SearchMustNotExpression.class);
            searchMustNotExpression.run();
        }
    }
    ...
    public void run() {
        try {
            ...
            final Expression expression = new MustNotExpression(new ValueExpression("keyword", "horse"));
